...
export class BufferIconDrawer {
  ...
  draw(g: Phaser.GameObjects.Graphics) {
    ...
    const points: Phaser.Math.Vector2[] = [
      new Phaser.Math.Vector2(-lowerWidth / 2, bottom),
      new Phaser.Math.Vector2(-lowerWidth / 2, bottom - lowerHeight),
      new Phaser.Math.Vector2(-upperWidth / 2, bottom - lowerHeight),
      new Phaser.Math.Vector2(0, top),
      new Phaser.Math.Vector2(upperWidth / 2, bottom - lowerHeight),
      new Phaser.Math.Vector2(lowerWidth / 2, bottom - lowerHeight),
      new Phaser.Math.Vector2(lowerWidth / 2, bottom),
    ];
